...
{
  ros::init(argc, argv, "motion_planning_xylophone");
  ...
  // Pose Goal
  // ^^^^^^^^^
  // We will now create a motion plan request for the arm of the Roboy
  ...
  pose.pose.position.y = 0.0465;
  pose.pose.position.z = -0.00567;
  ...
  moveit_msgs::Constraints pose_goal =
      kinematic_constraints::constructGoalConstraints("hand_left", pose, tolerance_pose, tolerance_angle);
